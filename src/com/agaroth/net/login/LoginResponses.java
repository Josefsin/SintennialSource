...
import com.agaroth.world.entity.impl.player.PlayerLoading;
...
public final class LoginResponses {
	...
	public static final int getResponse(Player player, LoginDetailsMessage msg) {
		...
		if(playerLoadingResponse == LoginResponses.NEW_ACCOUNT && (msg.getUsername().toLowerCase().contains("agaroth") || msg.getUsername().toLowerCase().contains("ivo"))) {
