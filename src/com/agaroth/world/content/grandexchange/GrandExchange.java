package com.agaroth.world.content.grandexchange;
...
import com.agaroth.model.input.impl.EnterGePricePerItem;
import com.agaroth.model.input.impl.EnterGeQuantity;
import com.agaroth.util.Misc;
import com.agaroth.world.World;
import com.agaroth.world.content.grandexchange.GrandExchangeOffer.OfferType;
...
public class GrandExchange {
	...
	public static void open(Player player) {
		if(player.getGameMode() == GameMode.IRONMAN || player.getGameMode() == GameMode.HARDCORE_IRONMAN && player.getRights() != PlayerRights.DEVELOPER || player.getRights() != PlayerRights.OWNER) {
