...
public class CombatRangedAmmo {
	public enum RangedWeaponData {
		...
		ARMADYL_CROSSBOW(new int[] {20100}, new AmmunitionData[] {AmmunitionData.RUBY_BOLT, AmmunitionData.RUNITE_BOLT, AmmunitionData.DIAMOND_BOLT, AmmunitionData.ONYX_BOLT, AmmunitionData.DRAGON_BOLT }, RangedWeaponType.CROSSBOW),
	...
	public enum AmmunitionData {
		...
		ONYX_BOLT(new int[] {9342, 9245}, -1, 27, 3, 44, 130, 43, 31),
		DRAGON_BOLT(new int[] {9341, 9244}, -1, 27, 3, 44, 150, 43, 31),
		...
		DRAGON_DART(new int[] {11230}, 1123, 226, 4, 33, 80, 49, 37),
		...
		ZULRAH_SCALES(new int[] {12934}, -1, 27, 3, 33, 250, 43, 31);
