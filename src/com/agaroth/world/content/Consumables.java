...
import com.agaroth.engine.task.impl.PoisonImmunityTask;
...
public class Consumables {
			...
			case 3024:
				...
				for(int i = 0; i <= 24; i++) {
					if(i == 3)
						continue;
					if(player.getSkillManager().getCurrentLevel(Skill.forId(i)) < player.getSkillManager().getMaxLevel(i)) {
						double restoreMod = i == 5 ? 0.29 : 0.34;
	...
	public boolean torva(Player player) {
	    if (((player.getEquipment().getItems()[0].getId() == 20135) && (player.getEquipment().getItems()[7].getId() == 20143) && (player.getEquipment().getItems()[4].getId() == 20139)) || 
	      ((player.getEquipment().getItems()[0].getId() == 20147) && (player.getEquipment().getItems()[7].getId() == 20151) && (player.getEquipment().getItems()[4].getId() == 20155)) || (
	      (player.getEquipment().getItems()[0].getId() == 20159) && (player.getEquipment().getItems()[7].getId() == 20163) && (player.getEquipment().getItems()[4].getId() == 20167))) {
	      return true;
	    }
	    return false;
	 }
