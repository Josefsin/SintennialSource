...
public enum TeleportType {
	...
	NORMAL(3, new Animation(8939, 25), new Animation(8941), null, null),
	...
	LEVER(3, new Animation(2140, 20), Animations.DEFAULT_RESET_ANIMATION, new Graphic(1576), new Graphic(1577)),
	...
	public Graphic getStartGraphic() {
		return this == NORMAL ? new Graphic(1576) : startGraphic;
	}
