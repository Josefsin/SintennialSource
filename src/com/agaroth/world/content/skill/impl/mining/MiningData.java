package com.agaroth.world.content.skill.impl.mining;
...
public class MiningData {
	...
	public static enum Pickaxe {
		Bronze(1265, 1, 6752, 1.0),
		Iron(1267, 1, 6754, 1.05),
		Steel(1269, 6, 6755, 1.1),
		Mithril(1273, 21, 6757, 1.2),
		Adamant(1271, 31, 6756, 1.25),
		Rune(1275, 41, 6758, 1.3),
		Dragon(15259, 61, 6758, 1.50),
		DragonU(20117, 61, 12188, 1.7),
	...
	public static enum Ores {
		Rune_essence(new int[] { 24444 }, 1, 30, 1436, 2, -1),
		Pure_essence(new int[] { 24445 }, 17, 45, 7936, 3, -1),
		...
		Adamantite(new int[] { 11941, 11939, 29233, 29235 }, 70, 7560, 449, 7, 14),
		Runite(new int[] { 14859, 4860, 2106, 2107 }, 85, 9122, 451, 7, 45),
		CRASHED_STAR(new int[] { 38660 }, 80, 6727, 13727, 7, -1);
