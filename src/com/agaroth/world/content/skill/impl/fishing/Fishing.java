package com.agaroth.world.content.skill.impl.fishing;
...
public class Fishing {
	...
	public enum Spot {
		...
		LURE(318, new int[]{335, 331}, 309, 314, new int[]{20, 30}, true, new int[]{1550, 2120}, 622),
		...
		BAIT(316, new int[]{327, 345}, 307, 313, new int[]{5, 10}, true, new int[]{650, 980}, 622),
		
		ROCKTAIL(10091, new int[]{15270}, 309, 25, new int[]{91}, false, new int[]{18010}, 622);
