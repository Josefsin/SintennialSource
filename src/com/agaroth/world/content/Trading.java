...
public class Trading {
	...
	public void requestTrade(Player player2) {
		...
		if(player2.getGameMode() == GameMode.HARDCORE_IRONMAN) {
			player.getPacketSender().sendMessage("That player is an Hardcore-Ironman player and can therefore not stake.");
			return;
		}
	...
	public void sendText(Player player2) {
		...
		player2.getPacketSender().sendString(3417, "Trading with: " + Misc.formatPlayerName(player.getUsername()) + " (Pouch: " + player.getMoneyInPouch() + ")");
		player.getPacketSender().sendString(3451, "" + Misc.formatPlayerName(player2.getUsername()) + "");
		player.getPacketSender().sendString(3417, "Trading with: " + Misc.formatPlayerName(player2.getUsername()) + " (Pouch: " + player2.getMoneyInPouch() + ")");
