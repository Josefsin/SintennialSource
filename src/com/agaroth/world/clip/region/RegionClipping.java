package com.agaroth.world.clip.region;
...
import com.agaroth.world.clip.stream.ByteStream;
...
public final class RegionClipping {
	...
	public static boolean objectExists(GameObject object) {
		...
		boolean rfd = id == 12356
				&& (pos.getX() == 3090 && pos.getY() == 3488
						|| pos.getX() == 1899 && pos.getY() == 5366
						|| pos.getX() == 1910 && pos.getY() == 5356 || pos
						.getX() == 1889 && pos.getY() == 5355);
		boolean rfdchest = id == 2182 && pos.getX() == 3091 && pos.getY() == 3487;
		boolean obelisk = id == 29944 && pos.getX() == 2111 && pos.getY() == 3917 || id == 29942 
				&& pos.getX() == 3090 && pos.getY() == 3499;
		boolean summonladder = id == 1746 && pos.getX() == 3090 && pos.getY() == 3492;
		boolean prayeraltar = id == 409 && pos.getX() == 3085 && pos.getY() == 3509;
		boolean cursealtar = id == 411 && pos.getX() == 3085 && pos.getY() == 3511;
		boolean ancientaltar = id == 6552 && pos.getX() == 3090 && pos.getY() == 3508;
		boolean lunaraltar = id == 410 && pos.getX() == 3089 && pos.getY() == 3511;
		...
		boolean crystalChest = id == 172 && pos.getX() == 3085 && pos.getY() == 3485;
		boolean stalls = id == 4875 && pos.getX() == 3094 && pos.getY() == 3500 || id == 4874
				&& pos.getX() == 3095 && pos.getY() == 3500 || id == 4876 && pos.getX() == 3096 
				&& pos.getY() == 3500 || id == 4877 && pos.getX() == 3097 && pos.getY() == 3500
				|| id == 4878 && pos.getX() == 3098 && pos.getY() == 3500;
		boolean scoreboard = id == 30205 && pos.getX() == 3086 && pos.getY() == 3485;
		boolean halloweenchest = id == 2403 && pos.getX() == 3110 && pos.getY() == 3361 && pos.getZ() == 2;
		if (halloweenchest || scoreboard || rfdchest || lunaraltar || ancientaltar || cursealtar || prayeraltar || summonladder || stalls || well || mageBankLever || lawAltar || trees || chaosTunnels || obelisk || barrows || rfd || lumbridgeCastle || barbCourseRopeswing || catherbyAquariums || freeForAllPortal || warriorsGuild || fightPit || godwars || barrows || waterRcAltar || crystalChest)
			return true;
