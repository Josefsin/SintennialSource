...
import com.agaroth.world.content.PlayerPunishment.Jail;
...
public class Locations {
	...
	public enum Location {
		KRAKEN(new int[]{3672, 3690}, new int[]{9875, 9899}, true, false, true, true, true, true) {
			@Override
		...
		GAMBLE(new int[]{3415, 3435}, new int[]{2900, 2926}, false, true, true, false, false, true) {
		},
		EXTREME_ZONE(new int[]{3415, 3435}, new int[]{2900, 2926}, false, true, true, false, false, true) {
		},
		...
		CORPOREAL_BEAST(new int[]{2879, 2974}, new int[]{4368, 4415}, true, false, true, false, true, true) {
		},
			...
			public boolean canTeleport(Player player) {
				if(player.getWildernessLevel() > 20) {
					if(player.getRights() == PlayerRights.ADMINISTRATOR || player.getRights() == PlayerRights.OWNER || player.getRights() == PlayerRights.DEVELOPER) {
						player.getPacketSender().sendMessage("@red@As an higher rank staff member you managed to teleport out from wilderness above lvl 20.");
						return true;
					}
		...
		ZULRAH_SHRINE(new int[]{2256, 2280}, new int[]{3061, 3082}, true, true, false, false, false, false) {},
		...
		DUEL_ARENA(new int[]{3322, 3394, 3311, 3323, 3331, 3391}, new int[]{3195, 3291, 3223, 3248, 3242, 3260}, false, false, false, false, false, false) {
			...
			public void enter(Player player) {
				...
				player.getPacketSender().sendMessage("<img=11> <col=996633>Warning! Do not stake items which you are not willing to lose.");
			}
		...
		GODWARS_DUNGEON(new int[]{2800, 2950, 2858, 2943}, new int[]{5200, 5400, 5180, 5230}, true, true, true, false, true, true) {
			...
			public boolean handleKilledNPC(Player killer, NPC n) {
				...
				if(npc == 6246 || npc == 6229 || npc == 6230 || npc == 6231) //Armadyl
					...
					index = 2;
				else if(npc == 10216 || npc == 6216 || npc == 6007 || npc == 6219 ||npc == 6220 || npc == 6221 || npc == 49 || npc == 4418) //Zamorak
					index = 3;
				if(index != -1) {
		...
		REVENANTS(new int[]{3650, 3715}, new int[]{3459, 3528}, true, true, true, false, false, false) {
		},
		...
		public static boolean inMulti(Character gc) {
			if(gc.getLocation() == WILDERNESS) {
				...
				|| ((x >= 3650) && (x <= 3705) && (y >= 3459) && (y <= 3529))
				|| ((x >= 3020) && (x <= 3055) && (y >= 3684) && (y <= 3711))
				|| ((x >= 3150) && (x <= 3195) && (y >= 2958) && (y <= 3003))
				|| ((x >= 3186) && (x <= 3273) && (y >= 3904) && (y <= 3964)))
					return true;
			}
